...
public class VariableExpenseController {
    ...
    @PostMapping
    public ResponseEntity<VariableExpenseDTO> createVariableExpense(@RequestBody VariableExpenseDTO variableExpenseDTO, @RequestParam String responsible) {
    ...
    public ResponseEntity<VariableExpenseDTO> updateVariableExpense(@PathVariable Long id,
        ...
        if (true) {
            ...
            try {
                VariableExpenseDTO updatedExpense = variableExpenseService.updateVariableExpense(id, variableExpenseDTO, responsavel);
    ...
    public ResponseEntity<VariableExpenseApprovalDTO> approveVariableExpense(@PathVariable Long id, @RequestBody VariableExpenseApprovalDTO approvalDTO, @RequestParam String responsavel) {

        if (true) {
            try {
                VariableExpenseApprovalDTO approvedExpense = variableExpenseService.approveVariableExpense(id, approvalDTO,responsavel );
